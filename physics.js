...
function createVehicle(pos, quat) {
  ...
  const geometry = new Ammo.btCompoundShape();
  geometry.addChildShape(new Ammo.btTransform(), new Ammo.btBoxShape(new Ammo.btVector3(chassisWidth * .5, chassisHeight * .5, chassisLength * .5)));
